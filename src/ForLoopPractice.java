...
public class ForLoopPractice {
    public static void main(String[] args) {
        ...
        // Your code here:
        System.out.println("Kelipatan 5 dari 5 ke 50: ");
        ...
        for (int i = 0; i < numbers.length; i++) {
            System.out.println("Print setiap elemen: " + numbers[i]);
        }
        ...
        for (int i = 0; i < word.length(); i++) {
            System.out.println("Print setiap huruf: " + word.charAt(i));
        }
        ...
        // Your code here:
        System.out.println("Print dalam reverse order: ");
