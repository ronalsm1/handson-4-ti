...
public class JumpStatementsPractice {
    public static void main(String[] args) {
        ...
        // Your code here:
        System.out.println("Hitung tapi break saat angka 8: ");
        for (int i = 1; i <= 20; i++) {
            if (i == 8) {
                break;
            }
        ...
        // Your code here:
        System.out.println("Hitung tapi angka genap diskip: ");
        for (int i = 1; i <= 10; i++) {
            if (i % 2 == 0) {
                continue;
            }
        ...
        for (int angka : numbers) {
            if (angka < 0) {
                System.out.println("Angka negatif yg pertama ketemu: " + angka);
                break;
            }
        }
        ...
        // Your code here:
        System.out.println("Hitung tapi angka yg bisa dibagi 3 diskip: ");
        for (int i = 1; i <= 15; i++) {
            if (i % 3 == 0) {
                continue;
            }
        ...
        for (int i = 0; i < word.length(); i++) {
            char konsonan = word.charAt(i);
            switch (konsonan) {
                case 'a', 'i', 'u', 'e', 'o': continue;
            }
        ...
        for (int i = 1; i <= 6; i++) {
            for (int j = 1; j <= 6; j++) {
                if (i * j > 15) {
                    System.out.println("Ketemu pasangan pertama (" + i + "," + j + ") dimana " + i + "*" + j + " = " + (i * j));
                    found = true;
                    break;
                }
            }
        ...
        for (String kata : words) {
            ...
            System.out.println("Print string dgn panjang minimal 5: " + kata);
        }
        ...
        for (int i = 1; i <= 3; i++) {
            for (int j = 1; j <= 3; j++) {
                if (i == 2 && j == 2) {
                    System.out.println("Exit outer loop at (" + i + "," + j + ")");
                    break outerLoop;
                }
        ...
        // Your code here:
        System.out.println("Hitung tapi angka yg bisa dibagi 2 dan 3 diskip: ");
        for (int i = 1; i <= 20; i++) {
            if (i % 2 == 0 & i % 3 == 0) {
                continue;
            }
        ...
        while (c < commands.length) {
            System.out.println("Perintah: " + commands[c]);
            if (commands[c] == "quit") {
                break;
            }
            c++;
        ...
        // Your code here:
        System.out.println("Hitung tapi angka yg bisa dibagi 5 diskip dan break saat angka di atas 25: ");
        for (int i = 1; i <= 30; i++) {
            if (i % 5 == 0) {
                continue;
            }
