...
public class ForEachLoopPractice {
    public static void main(String[] args) {
        ...
        for (int angka : numbers) {
            System.out.println("Print setiap angka: " + angka);
        }
        ...
        for (String buah : fruits) {
            System.out.println("Print setiap buah: " + buah);
        }
        ...
        // Your code here:
        for (int angka : original) {
            System.out.println("Print setiap angka yg dikalikan 2: " + (angka * 2));
        }
        ...
        // Your code here:
        for (char huruf : letters) {
            System.out.println("Print setiap huruf dalam nilai ASCII: " + (int) huruf);
        }
        ...
        // Your code here:
        for (String warna : colors) {
            System.out.println("Print setiap warna: " + warna);
        }
        ...
        // Your code here:
        for (String kata : sentences) {
            System.out.println("Print setiap kata dalam huruf besar: " + kata.toUpperCase());
        }
        ...
        int evenCount = 0;
        // Your code here:
        for (int angkaAcak : mixedNumbers) {
            if (angkaAcak % 2 == 0) {
                evenCount++;
            }
        }
