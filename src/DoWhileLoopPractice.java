...
public class DoWhileLoopPractice {
    public static void main(String[] args) {
        ...
        do {
            ...
            choice = 2;
            System.out.println("Pilih: " + choice);
        } while (choice != 2);
        System.out.println("Kamu keluar!");
        ...
        do {
            System.out.println("Masukkan ulang nilai antara 1 dan 10: ");
            inputValue = 9;
        ...
        // Your code here:
        do {
            System.out.println("Pesan ini ditampilkan setidaknya sekali");
        } while (condition);
        ...
        // Your code here:
        do {
            System.out.println("Hitung mundur: " + timer);
            timer--;
        } while (timer >= 1);
        ...
        // Your code here:
        do {
            System.out.println("Masukkan ulang password yang benar: ");
        ...
        if (enteredPassword.equals(correctPassword)) {
            ...
            System.out.println("Akses ditolak! Maksimum percobaan 3x tercapai");
        }
